...
from .network_agent import NetworkAgent, slice_tensor, relation, sum_axis_2
import numpy as np
import random
...
class MPLightAgent(NetworkAgent):
    ...
    def build_network(self):
        ...
        if self.num_actions == 8:
            q_values = Lambda(sum_axis_2, output_shape=(8,), name="q_values")(Reshape((8, 7))(before_merge))
        else:
            q_values = Lambda(sum_axis_2, output_shape=(4,), name="q_values")(Reshape((4, 3))(before_merge))
