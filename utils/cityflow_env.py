...
class CityFlowEnv:
    ...
    def reset(self):
        ...
        cityflow_seed = self.dic_traffic_env_conf.get("CITYFLOW_SEED", None)
        if cityflow_seed is None:
            cityflow_seed = int(np.random.randint(0, 100))
        cityflow_config = {
        ...
        cityflow_config["seed"] = int(cityflow_seed)
